      ...
      {({ open }) => (
        <>
            ...
            <div className="flex justify-between h-16">
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <button
                    type="button"
                    className="relative inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-full text-white bg-teal-600 shadow-sm hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500"
                  >
                    <span>Contact</span>
                  </button>
                </div>
          ...
          <Disclosure.Panel className="md:hidden">
            <MenuNav items={navigation} className="pt-2 pb-3 space-y-1"></MenuNav>
            <div className="pt-4 pb-3 border-t border-gray-200">
              <div className="flex items-center px-4 sm:px-6">
                ...
                <div className="ml-3">
                  ...
                  <div className="text-sm font-medium text-gray-500">admin@watheia.org</div>
                </div>
                <button
                  type="button"

...
const NavLink = ({ name, href }: NavItem) => {
  ...
  return (
    <a href={href} className="font-medium text-gray-500 hover:text-gray-900 hover:border-b">
      {name}
    </a>
  )
}
const OpenMenuButton = (props: Record<string, any>) => (
  <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-aqua-500" {...props}>
...
const FlyoutMenuButton = ({ open, label, ...props }: FlyoutMenuButtonProps) => (
  <Popover.Button
    className={clsx(
      ...
      'group bg-white rounded-md inline-flex items-center text-base font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-aqua-500'
    )}
    {...props}
  >
      ...
      <div className="flex justify-between items-center px-4 py-6 sm:px-6 md:justify-start md:space-x-10">
        ...
        <div className="hidden md:flex-1 md:flex md:items-center md:justify-between">
                        ...
                        <div className="p-5 bg-gray-50 sm:p-8">
                          <a href="#" className="-m-3 p-3 flow-root rounded-md hover:bg-gray-100">
                            <div className="flex items-center">
                              ...
                              <span className="ml-3 inline-flex items-center px-3 py-0.5 rounded-full text-xs font-medium leading-5 bg-aqua-100 text-aqua-800">
                                New
                              </span>
                            </div>
          ...
          <div className="flex items-center md:ml-12">
            <NavLink name="Sign In" href="/auth" />
          </div>
        </div>
      </div>
              ...
              <div className="mt-6">
                <nav className="grid gap-6">
                  {solutions.map((item) => (
                    ...
                    >
                      <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-aqua-500 text-white">
                        <item.icon className="h-6 w-6" aria-hidden="true" />
                      </div>

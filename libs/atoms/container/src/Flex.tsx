...
import styles from "./styles/flex-gap.module.css"
    ...
    const style = {
      ...
      "--column-gap":
        props.columnGap != null
          ? responsiveDimensionValue(props.columnGap, matchedBreakpoints)
          : undefined,
      "--row-gap":
        props.rowGap != null
          ? responsiveDimensionValue(props.rowGap, matchedBreakpoints)
          : undefined,
      "--gap":
        props.gap != null
          ? responsiveDimensionValue(props.gap, matchedBreakpoints)
          : undefined
    }
 ...
 */
function flexAlignValue(value: string) {
  if (value === "start") {
    return "flex-start"
  }

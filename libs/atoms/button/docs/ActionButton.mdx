...
<HeaderInfo
  ...
  sourceData={[{ type: "Spectrum", url: "https://watheia.app/docs/action-button/" }]}
/>
...
function Example() {
  ...
  return <ActionButton onPress={() => setCount((c) => c + 1)}>{count} Edits</ActionButton>
}
```
...
[View guidelines](https://watheia.app/docs/action-button/#Quiet)
...
[View guidelines](https://watheia.app/docs/action-button/#Disabled)
